<?php
	if ($content == "dashboard"){
		...
		$this->load->view('sysadmin/tabel');
	}elseif ($content == "data-banner"){
	$this->load->view('sysadmin/tabel');
	}elseif ($content == "data-menu"){	
	$this->load->view('sysadmin/tabel');
	}elseif ($content == "data-submenu"){	
	$this->load->view('sysadmin/tabel');
	}elseif ($content == "data-konten"){		
		$this->load->view('sysadmin/tabel');
	}elseif ($content == "data-surat"){
		$this->load->view('sysadmin/tabel');
	}elseif ($content == "data-wilayah"){
		$this->load->view('sysadmin/tabel');	
	}
?>